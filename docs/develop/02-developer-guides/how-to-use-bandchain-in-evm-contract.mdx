...
<img src="/img/make_new_request.png") style={{ height: 300 + 'px' }}/>

You will see a set of inputs of this Oracle Script 

<img src="/img/oracle_script_input.png") style={{ height: 700 + 'px' }}/>
...
<img src="/img/datasources_example.png" style={{ height: 400 + 'px' }}/>
...
<img src="/static/img/request_result.png" style={{ height: 300 + 'px' }}/>
