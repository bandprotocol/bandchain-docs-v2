...
<img src="/img/make_new_request.png" style={{ maxHeight: 300 + 'px' }}/>

You will see a set of inputs of this Oracle Script 

<img src="/img/oracle_script_input.png" style={{ maxHeight: 700 + 'px' }}/>

There are two main types of input in this image. The first type is input of the Oracle Script which can be vary among the Oracle Script and the Second type is the input require by BandChain itself.

There are two inputs for each type you need to know.
...
<img src="/img/datasources_example.png" style={{ maxHeight: 400 + 'px' }}/>
...
<img src="/img/request_result.png" style={{ maxHeight: 300 + 'px' }}/>
...
To integrate BandChain data into your contract, you need to accomplish two things. Firstly, your contract must inherit the BandBridgeConsumer contract. Secondly, you must implement the function _handleOracleResponse within your contract.
